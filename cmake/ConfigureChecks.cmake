...
if(HAVE_DLFCN_H)
  ...
  check_symbol_exists(RTLD_DEEPBIND  "${CFG_HEADERS}" HAVE_DECL_RTLD_DEEPBIND)
  check_symbol_exists(RTLD_GLOBAL    "${CFG_HEADERS}" HAVE_DECL_RTLD_GLOBAL)
  check_symbol_exists(RTLD_LAZY      "${CFG_HEADERS}" HAVE_DECL_RTLD_LAZY)
  check_symbol_exists(RTLD_LOCAL     "${CFG_HEADERS}" HAVE_DECL_RTLD_LOCAL)
  check_symbol_exists(RTLD_NODELETE  "${CFG_HEADERS}" HAVE_DECL_RTLD_NODELETE)
  check_symbol_exists(RTLD_NOLOAD    "${CFG_HEADERS}" HAVE_DECL_RTLD_NOLOAD)
  check_symbol_exists(RTLD_NOW       "${CFG_HEADERS}" HAVE_DECL_RTLD_NOW)
