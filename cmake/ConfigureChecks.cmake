...
if(HAVE_LONG_LONG)
  if(OFF_T GREATER LONG
      AND (LONG_LONG GREATER OFF_T OR LONG_LONG EQUAL OFF_T))      
...
if("${Py_UNICODE_SIZE}" STREQUAL "${WCHAR_T}")
  ...
  if("${Py_UNICODE_SIZE}" STREQUAL "${SHORT}")
    ...
    endif("${Py_UNICODE_SIZE}" STREQUAL "${LONG}")

  endif("${Py_UNICODE_SIZE}" STREQUAL "${SHORT}")

endif("${Py_UNICODE_SIZE}" STREQUAL "${WCHAR_T}")
...
check_type_size(socklen_t sys/socket.h SOCKLEN_T)
unset(CMAKE_EXTRA_INCLUDE_FILES)
...
add_cond(CMAKE_REQUIRED_DEFINITIONS SIZEOF_VOID_P "-DSIZEOF_VOID_P=${VOID_P}")
